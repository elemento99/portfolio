...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        posible para que pudiera usarse incluso durante el ejercicio.`},{title:"Melody Explorer",url:"https://elemento99.github.io/melody_explorer/",description:"Plataforma para explorar melodías generadas a partir de parámetros definidos por el usuario.",technologies:"HTML5, CSS, JS",story:`Melody Explorer surgió de mi pasión por la música y las matemáticas. 
