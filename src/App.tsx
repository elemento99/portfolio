...
const Aside = () => (
    <aside>
        ...
        <h2>Aptitudes</h2>
        <h3>Técnicas</h3>
        <p>JavaScript, NodeJS, SQL, Python, React, Bootstrap, R</p>
        <h3>Blandas</h3>
        ...
        <ul>
            ...
            <li>Profesor de Matemática, Colegio Virtual (2023)</li>
        ...
        <ul>
            ...
            <li>Talento digital, Santiago: Bootcamp Full Stack JavaScript (2024)</li>
